...
chessboardSize = (10, 7)
size_of_chessboard_squares_mm = 50.00

# Common resolutions 1920x1080; 1280x720
frameSize = (6000,4000)  # Img Resolution

images = glob.glob('Canon_Sim_Veri/*.JPG')  # Image DIR and type
...
def display_resized_image(image):
    ...
    desired_width = width // 25
    desired_height = height // 25
...
for image in images:
    ...
    if ret == True:
        print("Calibration Points found")
